...
//     // Add group to each member's `groups` array and send notification
//     for (const m of members) {
//       const user = await User.findById(m.userId);
//       if (user) {
//        if (!user.groups.some(g => g.toString() === savedGroup._id.toString())) {
...
//       }
//     }
//      const creatorInGroup = creator.groups.some(g => g.toString() === savedGroup._id.toString());
//     if (!creatorInGroup) {
//       creator.groups.push(savedGroup._id);
//       await creator.save();
//       console.log(`✅ Group also added to creator (${creator.email})`);
//     }
